package com.example.root.myvolleydemo.scanBYGooglePlay;
...
public class GoogleScanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityCompat.requestPermissions(GoogleScanActivity.this, new
        ...
        switch (requestCode) {
            case REQUEST_WRITE_PERMISSION:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(GoogleScanActivity.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
